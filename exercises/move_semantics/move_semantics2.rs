...
fn main() {
    ...
    // let mut vec1 = fill_vec(vec0.clone()); // option 1
    // let mut vec1 = fill_vec(&vec0); // option 2
    fill_vec(&mut vec0);
...
// fn fill_vec(vec: &Vec<i32>) -> Vec<i32> { // option 2
//     let mut vec = vec.clone(); // option 2
fn fill_vec(vec: &mut Vec<i32>) {
    // let mut vec = vec; // removed for option 3
